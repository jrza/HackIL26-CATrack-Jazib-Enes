...
export default function MetaLogo({ size = 24, color }: MetaLogoProps) {
  const useGradient = !color;
  const fill0 = color ?? '#0081fb';

  return (
    <Svg width={size} height={size * (191 / 290)} viewBox="0 0 290 191">
      {useGradient && (
        <Defs>
